...
#     """
#     Converts a fast.ai's image object into a string
#
#     :param images_fname_list: (list of strings) List of image file names
#     :param directory_path: (string) path of directory that contains the images
#     :return: (string) JSON serialized version of the images of interest
#     """
#
#     if not isinstance(images_fname_list, list):
#         images_fname_list = [images_fname_list]
#
#     im_master_list = []
#
...
#         # 1. Extraction of the pixel values, 2. conversion into a numpy array,
#         # 3. conversion into a list
#         imarrlist = im.data.cpu().numpy().tolist()
#         # Appending of that list to the list of list
#         # representing the list of images passed as input
...
if __name__ == "__main__":
    webservice_url = sys.argv[1]
    auth_key = sys.argv[2]
    # app.jinja_env.globals.update(predictions_file=predictions_file)
    app.run()
